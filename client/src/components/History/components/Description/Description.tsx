...
export const Description: FC<IHistoryItem> = ({prev, next, taskName, dueData}) =>     
    {
        const {createDate} = formattedData(dueData);
    
        return <li data-testid="type-description" key={dueData} className="text-slate-500 text-xs flex flex-col gap-2">
